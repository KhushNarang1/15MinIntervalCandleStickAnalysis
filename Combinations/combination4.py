#  bullish --> marubuzu + 3 white soilders
#  bearish --> marubuzu + 3 black rows
...
white_count = 0
black_count = 0
bullish_marubuzu_pattern = 0
bearish_marubuzu_pattern = 0

for j in range(0, 54):
    combinationType = 'marubuzu+3Whitesoilders/marubuzu+3BlackRows'
    ...
    bullish_marubuzu_pattern += len([x for x in marubuzu_pattern  if x == 100])
